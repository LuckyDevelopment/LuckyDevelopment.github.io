...
I've been coding for a while now, and I've mostly made systems. Not full fledged games. If you need a system for your game then I'm the perfect choice for you. I use a modular framework like Knit, and so I write professional code with not a ton of functions and random if statements. I've made:

- Vehicle Chassis
-  Backend and Frontend Systems
-  Was Head Developer of Roblox's biggest slot car group in 2024. (3k+ people)
-  Frameworks
-  Plugins
...
I will really do anything you need, as long as it is not a super small feature.

### What I will not/don't want to do: ❌

Create a whole entire game for you. I do commissions to make profit, and working on one game for a long time that others don't care about is a **no** for me.
...
They operate within in a discord server, so make sure to check that out.
...
I worked on rescripting a hangout game. Here is what I did.

- Nametag System
- Datastore and Leveling System
- Shop System
- VR System
- DJ System
- Gears
...
## 🖥️ Technical Skills
- **Languages:** Luau, Lua, JavaScript, HTML5, CSS3, C++, C#
- **Frameworks/Libraries:** Warp, Knit, Signal

## 📜 Links 
- [Roblox Profile](https://www.roblox.com/users/488202227/profile) 
- [Discord Server](https://discord.gg/dmpcv8FrKa)
